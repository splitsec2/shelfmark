...
- the release is not a multi-book pack — ranges like `1-24` or `Books 1 to 17`, or words like *complete*, *collection*, *box set*, *omnibus*, *+ short stories* — unless the requested title itself carries them;
